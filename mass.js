    ...
    //    $('input').change(function(){
           $.getJSON('/in/mass/processing',{
            ...
            chemical_dose_vol : $('input[name="chemical-dose-vol"]').val(),
                ...
                $("#output_mortar_volume_1").text(data.vol_mortar);
                $("#output_mortar_volume_2").text(data.vol_mortar);
                $("#output_mortar_volume_limit_1").text(data.vol_mortar_recommended);
                $("#output_mortar_volume_limit_2").text(data.vol_mortar_recommended);
